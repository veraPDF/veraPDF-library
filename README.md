...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.29/job/library/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.29/job/library/ "OPF Jenkins")
