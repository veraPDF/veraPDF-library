...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.24rc/job/library/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.24rc/job/library/ "OPF Jenkins")
