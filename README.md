...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/library-jakarta/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/library-jakarta/ "OPF Jenkins")
