...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/library/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/library/ "OPF Jenkins")
