...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/library-arlington/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/library-arlington/ "OPF Jenkins")
