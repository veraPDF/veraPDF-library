...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.30/job/library/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.30/job/library/ "OPF Jenkins")
