...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/library-arlington/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/library-arlington/ "OPF Jenkins")
