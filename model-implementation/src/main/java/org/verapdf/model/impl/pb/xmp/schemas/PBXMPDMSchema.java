...
/**
 * Current class is representation of XMPDMSchema interface from
...
public class PBXMPDMSchema extends PBXMPPredefinedSchema implements XMPDMSchema {
	...
	public static final String XMP_DM_SCHEMA_TYPE = "XMPDMSchema";
	...
	public PBXMPDMSchema(XMPSchema xmpSchema) {
		super(xmpSchema, XMP_DM_SCHEMA_TYPE);
	}
