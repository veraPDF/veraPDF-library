...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:profilens="http://www.verapdf.org/ValidationProfile">
    ...
    <xsl:template match="report">
        ...
        <h1 align="left"><strong><b>Validation Report</b></strong></h1>
    ...
    <xsl:template match="/report/validationInfo/result/summary">
        ...
        <table border="0" id="table2">
            <tr>
                <td width="200"><b>Passed rules:</b></td>
                <td><xsl:value-of select="@passedRules"/></td>
            </tr>
            <tr>
                <td width="200"><b>Passed Checks:</b></td>
                <td><xsl:value-of select="@passedChecks"/></td>
            </tr>
            <tr>
                <td width="200"><b>Failed rules:</b></td>
                <td><xsl:value-of select="@failedRules"/></td>
            </tr>
            <tr>
                <td width="200"><b>Failed Checks:</b></td>
                <td><xsl:value-of select="@failedChecks"/></td>
            </tr>
        </table>
    </xsl:template>
    ...
    <xsl:template match="/report/validationInfo/result/details/rules/rule">
        ...
        <tr style="BACKGROUND: #dcdaf6">
            <td width="500"><b>
                <xsl:value-of select="$profile/profilens:profile/profilens:rules/profilens:rule[@id = $id]/profilens:description"/>
            </b></td>
            <td><b>
        ...
        <xsl:for-each select="check[@status = 'failed']">
            <tr>
                <td width="500"><xsl:value-of select="error/message"/></td>
            </tr>
        </xsl:for-each>
