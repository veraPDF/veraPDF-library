 ...
 * Filters - LZW decode
 */
public class VeraPDF_6_1_10_t01_pass_a_IT extends BasePDFAIT {
    ...
    protected String getExpectedReportFilePath() throws Exception {
        return getSystemIndependentPath(VERAPDF_EXPECTED_REPORTS_REPO_NAME + "pdfa_1/b_6_1_10_filters/6-1-12-t01-pass-a-report.xml");
    }
    ...
    protected String getPdfFilePath() throws Exception {
        return getSystemIndependentPath(VERA_PDF_TEST_FILES_REPO_NAME + "PDF_A-1b/6.1 File structure/6.1.10 Filters/veraPDF test suite 6-1-10-t01-pass-a.pdf");
    }
}
