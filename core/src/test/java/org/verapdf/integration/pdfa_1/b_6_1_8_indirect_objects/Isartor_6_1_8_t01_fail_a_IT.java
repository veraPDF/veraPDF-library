 ...
 */
public class Isartor_6_1_8_t01_fail_a_IT extends BasePDFAIT {
    ...
    protected String getExpectedReportFilePath() throws Exception {
        return getSystemIndependentPath(ISARTOR_EXPECTED_REPORTS_REPO_NAME + "pdfa_1/b_6_1_8_indirect_objects/6-1-8-t01-fail-a-report.xml");
    }
    ...
    protected String getPdfFilePath() throws Exception {
        return getSystemIndependentPath(ISARTOR_TEST_FILES_REPO_NAME + "PDFA-1b/6.1 File structure/6.1.8 Indirect objects/isartor-6-1-8-t01-fail-a.pdf");
    }
}
