...
public class ValidationProfileImplTest {
	...
	public final void testEqualsObject() {
		EqualsVerifier.forClass(ValidationProfileImpl.class).withIgnoredFields("ruleLookup", "objectVariableMap", "objectRuleMap", "lock").suppress(Warning.NULL_FIELDS).verify();
	}
