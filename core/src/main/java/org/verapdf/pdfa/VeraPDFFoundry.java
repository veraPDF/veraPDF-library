...
public interface VeraPDFFoundry extends Component {
     ...
     *
     * @param pdfStream {@link java.io.InputStream} for the PDF document to be parsed.
     *
     ...
     * @throws EncryptedPdfException if the PDF to be parsed is encrypted
     */
    PDFAParser createParser(InputStream pdfStream, PDFAFlavour flavour)
            throws ModelParsingException, EncryptedPdfException;

    PDFAParser createParser(InputStream pdfStream, PDFAFlavour flavour, PDFAFlavour defaultFlavour)
            throws ModelParsingException, EncryptedPdfException;

    PDFAParser createParser(InputStream pdfStream, PDFAFlavour flavour, String password)
            throws ModelParsingException, EncryptedPdfException;
     ...
     * @throws EncryptedPdfException if the PDF to be parsed is encrypted
     */
    PDFAParser createParser(File pdfFile, PDFAFlavour flavour)
            throws ModelParsingException, EncryptedPdfException;

    PDFAParser createParser(File pdfFile, PDFAFlavour flavour, PDFAFlavour defaultFlavour)
            throws ModelParsingException, EncryptedPdfException;

    PDFAParser createParser(File pdfFile, PDFAFlavour flavour, String password)
            throws ModelParsingException, EncryptedPdfException;

    PDFAParser createParser(File pdfFile, PDFAFlavour flavour, PDFAFlavour defaultFlavour, String password)
            throws ModelParsingException, EncryptedPdfException;
     ...
     * the flavour of the PDF document stream and provide an appropriate parser.
     *
     * @param pdfFile {@link java.io.File} with the PDF document to be parsed.
     *
     * @return a {@link PDFAParser} instance created from the supplied
     * InputStream.
     *
     ...
     * @throws EncryptedPdfException if the PDF to be parsed is encrypted
     */
    PDFAParser createParser(File pdfFile)
            throws ModelParsingException, EncryptedPdfException;

    /**
     * Obtain a new {@link PDFAValidator} instance.
     *
     * @param config a {@link ValidatorConfig} instance used to configure the
     *               {@link PDFAValidator}
     *
     ...
     *
     * @param config  a {@link ValidatorConfig} instance used to configure the {@link PDFAValidator}
     ...
     * @param config  a {@link ValidatorConfig} instance used to configure the
     *                {@link PDFAValidator}
     * @param flavour the particular {@link org.verapdf.pdfa.flavours.PDFAFlavour}
     ...
     * @param config   a {@link ValidatorConfig} instance used to configure the
     *                 {@link PDFAValidator}
     * @param flavours the list of particular {@link org.verapdf.pdfa.flavours.PDFAFlavour}s
     *                 to validated against.
     *
     * @return an appropriately configured {@link PDFAValidator} instance.
     */
    PDFAValidator createValidator(ValidatorConfig config, List<PDFAFlavour> flavours);
     ...
     * {@link org.verapdf.pdfa.validation.profiles.Profiles#getVeraProfileDirectory()}.
     *
     * @param flavours list of the {@link PDFAFlavour} that are  associated with the
     *                 {@code ValidationProfile} to used to initialise the
     *                 {@code PDFAValidator}.
     *
     * @return a {@link PDFAValidator} instance initialised from the passed
     * parameters
     */
    PDFAValidator createValidator(List<PDFAFlavour> flavours);
    ...
    /**
     * Creates a new {@link PDFAValidator} initialised with the passed profile and chosen passed test logging.
     *
     * @param flavour                          the {@link PDFAFlavour} that's associated with the
     *                                         {@code ValidationProfile} to used to initialise the
     *                                         {@code PDFAValidator}.
     ...
     * @return a {@link PDFAValidator} instance initialised from the passed parameters
     */
    PDFAValidator createValidator(PDFAFlavour flavour, int maxNumberOfDisplayedFailedChecks,
     ...
     * @return a {@link PDFAValidator} instance initialised from the passed parameters
     */
    PDFAValidator createValidator(List<PDFAFlavour> flavour, int maxNumberOfDisplayedFailedChecks,
            boolean logSuccess, boolean showErrorMessages, boolean showProgress);
     ...
     * @return a {@link PDFAValidator} instance initialised from the passed parameters
     */
    PDFAValidator createValidator(ValidationProfile profile, int maxNumberOfDisplayedFailedChecks,
            boolean logSuccess, boolean showErrorMessages, boolean showProgress);

    /**
     * Creates a new {@link PDFAValidator} initialised with the passed profile, requested fast failing behaviour and
     * configured NOT to log passed checks.
     *
     * @param flavour                          the {@link PDFAFlavour} that's associated with the
     *                                         {@code ValidationProfile} to used to initialise the
     *                                         {@code PDFAValidator}.
     ...
     * @return a {@link PDFAValidator} instance initialised from the passed parameters
     */
    PDFAValidator createFailFastValidator(List<PDFAFlavour> flavours, int maxFailures,
            int maxNumberOfDisplayedFailedChecks,
            boolean logSuccess, boolean showErrorMessages, boolean showProgress);
