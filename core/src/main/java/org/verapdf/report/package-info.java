 ...
 * @since 0.7
 */
@javax.xml.bind.annotation.XmlSchema(namespace = "http://www.verapdf.org/MachineReadableReport", xmlns = {@XmlNs(prefix = "", namespaceURI = "http://www.verapdf.org/MachineReadableReport")}, elementFormDefault = XmlNsForm.QUALIFIED)
