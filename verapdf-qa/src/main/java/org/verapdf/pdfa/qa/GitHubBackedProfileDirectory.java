...
public enum GitHubBackedProfileDirectory implements ProfileDirectory {
    ...
    private static final Logger LOGGER = Logger.getLogger(GitHubBackedProfileDirectory.class);
    ...
    private transient final ProfileDirectory profiles;
    ...
    private static Set<ValidationProfile> fromGitHubBranch(
        ...
        for (PDFAFlavour flavour : PDFAFlavour.values()) {
            ...
            try {
                ...
                LOGGER.error("Could not load GitHub profile for " + flavour.getLevel().getName());
                LOGGER.error(e);
            }
        }
        return profileSet;
